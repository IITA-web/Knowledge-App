...
export default class iReportPhoto extends React.Component {
  static contextType = ThemeContext;
static navigationOptions = ({ navigation, navigationOptions }) => {
    return {
      tabBarLabel: "iReport Photos",
  ...
  componentDidMount(){
   ...
   fetchIreportPhotos = () => {
    ...
    const URL = 'getJson.php?page='+page;
...
retry = () =>{
 ...
 renderFooter = () => {
  ...
  render(){
    ...
    <Card style={{backgroundColor: theme === 'light' ? '#fff' : '#222'}} elevation={4} onPress={() => { navigate('iReportPhotosDetails', { title: item.title , data: item })}}>
